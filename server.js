...
const products = {
    'fish_feed': { name: 'Fish Feed', minQty: 10, price: 1200, unit: 'kg' },
    'catfish': { name: 'Catfish', minQty: 1, price: 2800, unit: 'kg' },
    'materials': { name: 'Materials', minQty: 50, price: 1000, unit: 'kg' }
};
